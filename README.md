...
*0% of the code was written by a human. 14,700+ lines of application code, 147 commits, 6 days — built entirely through conversation with [Claude Code](https://claude.ai/claude-code) and Opus 4.6. Day one was spent [teaching the model how to think](planning.md) before writing a single line of code — on purpose.*
